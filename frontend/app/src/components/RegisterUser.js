...
function RegisterUser() {
    ...
    function handleSubmit(event) {
        ...
        .then(function (res){ alert(`${res.data.user} account created`);
                ...
                <div className="auth-inner">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" className="form-control" placeholder="Enter username" name="user" onChange={handleInputChange} value={inputs.username}/>
                        </div>
                        <div className="form-group">
                            <label>Email:</label>
